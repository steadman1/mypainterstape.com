    ...
    static employees: Employee[] = [
        ...
        new Employee(
            ...
            [
                ...
                Skill.typescript.clone().complete(5, new Date(2020, 0, 1), true),
                Skill.python.clone().complete(5, new Date(2016, 0, 1), true),
                Skill.c_plus_plus.clone().complete(5, new Date(2020, 0, 1), true),
                Skill.java.clone().complete(4, new Date(2018, 0, 1), false),

                Skill.photoshop.clone().complete(4, new Date(2020, 0, 1), true),
                Skill.illustrator.clone().complete(5, new Date(2020, 0, 1), true),

                Skill.figma.clone().complete(3, new Date(2022, 0, 1), true),

                Skill.excel.clone().complete(5, new Date(2016, 0, 1), true),
                Skill.job_boss_2.clone().complete(5, new Date(2020, 0, 1), true),
            ]
        ),
